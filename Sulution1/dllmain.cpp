...
VOID StartHook()
{
	...
	if (!CLdrHeader::InlindeHook(Ptr, reinterpret_cast<void **>(&NewNtQuerySystemInformation), reinterpret_cast<void **>(&RealNtQuerySystemInformationPtr)))
	{
...
VOID StopHook()
{
	...
	{
		NtQuerySystemInformationPtr Ptr = (NtQuerySystemInformationPtr)::GetProcAddress(::GetModuleHandleW(L"ntdll.dll"), "NtQuerySystemInformation");
		CLdrHeader::UnInlineHook(Ptr, RealNtQuerySystemInformationPtr);
