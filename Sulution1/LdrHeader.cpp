...
BOOL CLdrHeader::InlindeHook(_In_ LPVOID HookProcPtr, _In_ LPVOID NewProcPtr, _Out_ LPVOID* RealProcPtr)
{
#define JMP_SIZE 0x5
	DWORD dwPatchSize	= 0;
...
VOID CLdrHeader::UnInlineHook(_In_ LPVOID HookProcPtr, LPVOID RealProcPtr)
{
	DWORD dwOldProectd	= 0;
	DWORD dwPatchSize	= 0;
...
BOOL CLdrHeader::GetPatchSize(_In_ LPVOID HookProcPtr, _In_ DWORD dwSize, _Out_ DWORD* pdwPatchSize)
{
	DWORD Length;
	PUCHAR pOpcode;
	DWORD PatchSize = 0;
...
ULONG __fastcall CLdrHeader::SizeOfCode(_In_ LPVOID Code, UCHAR ** pOpCode)
{
#define OP_NONE           0x00
